...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 105, 109, 115, 24865, 1821933, 4745537, 4846113, 4849249, 4949376, 5144726, 5243965, 5343647, 5393365, 5442204, 5442212, 5443986, 5541879, 5594513, 5594516, 5695307, 5741474, 24046298, 42740551, 52644165, 57219237, 67859554, 71225499, 76061764, 87367608, 96903864, 125111323, 142301684, 142895325, 159136996, 159137011, 222029606, 244830897, 261031087, 328878574, 359333139, 407283053, 451001976, 452737314, 480756972, 501039929, 520590566, 520665567, 596483356, 614073432, 724060212, 825785976, 834174833, 845179051, 910198946, 922671056, 946786476, 995006396, 1067353468, 1071652316, 1103412149, 1126920507, 1135981740, 1149080132, 1154932936, 1155848147, 1181037546, 1191633396, 1202718727, 1204816148, 1213952397, 1224901875, 1247875546, 1257164128, 1269755426, 1270053116, 1271070480, 1280549057, 1280845662, 1282943179, 1313416818, 1337394146, 1352786672, 1395555037, 1516338311, 1532710347, 1537812987, 1614780307, 1620824029, 1621420777, 1623148745, 1639293562, 1692511090, 1705629508, 1723805383, 1768164316, 1797611211, 1831108493, 1889672705, 1891834246, 1901487095, 1915412854, 1916009602, 1937159360, 2012934199, 2022294396, 2025055113, 2048392659, 2068341319, 2082663554, 2083500811, 2083776923, 2090667972, 2113708439, 2123232567, 2127021138};
		
		protected static string[] fields = new string[]{"b", "i", "m", "s", "op", "isGlobal", "__a", "add", "arr", "cur", "get", "idx", "key", "len", "map", "max", "min", "obj", "pop", "pos", "run", "set", "split", "flags", "match", "compare", "start", "conditionResults", "remove", "filter", "merge", "hashCode", "resize", "result", "matched", "matches", "setLoop", "compareArg", "get_length", "iterator", "lastIndexOf", "hasNext", "keysLoop", "reverse", "nOccupied", "insert", "length", "addSub", "balance", "matchedRight", "replace", "conditions", "value", "quotient", "compareArgs", "cachedIndex", "toString", "hashes", "splice", "exists", "copy", "matchSub", "fact", "expose", "removeLoop", "minBinding", "join", "keys", "left", "concat", "clear", "next", "push", "keyValueIterator", "root", "rule", "matchedPos", "size", "sort", "quicksort", "vals", "values", "spliceVoid", "cachedKey", "blackboard", "concatNative", "nBuckets", "offset", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "iteratorLoop", "toDynamic", "regex", "right", "getDefault", "get_reason", "set_reason", "_height", "rules", "__get", "__set", "__hx_deleteField", "modulus", "upperBound", "unshift", "_keys", "facts", "shift", "matchedLeft", "condition", "reason", "addChar", "removeMinBinding", "slice"};
