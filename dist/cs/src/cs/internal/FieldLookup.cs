...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{105, 24865, 4745537, 4849249, 5144726, 5393365, 5442204, 5541879, 5594513, 5695307, 57476627, 71225499, 76061764, 87367608, 142301684, 142895325, 159137011, 328878574, 359333139, 407283053, 452737314, 501039929, 520590566, 825785976, 834174833, 922671056, 946786476, 995006396, 1067353468, 1103412149, 1135981740, 1149080132, 1181037546, 1204816148, 1224901875, 1228056441, 1247875546, 1270053116, 1280845662, 1282943179, 1313416818, 1352786672, 1395555037, 1398464674, 1431819701, 1436822557, 1516338311, 1532710347, 1537812987, 1620824029, 1621420777, 1623148745, 1639293562, 1705629508, 1768617329, 1831108493, 1889672705, 1901487095, 1915412854, 1916009602, 1937159360, 2025055113, 2048392659, 2054707467, 2068341319, 2082663554, 2083776923, 2090667972, 2127021138};
		
		protected static string[] fields = new string[]{"i", "op", "__a", "arr", "get", "len", "map", "obj", "pop", "run", "getEnumConstructs", "conditionResults", "remove", "filter", "resize", "result", "matches", "iterator", "lastIndexOf", "hasNext", "reverse", "insert", "length", "conditions", "value", "cachedIndex", "toString", "hashes", "splice", "copy", "fact", "expose", "join", "concat", "next", "enumConstructor", "push", "rule", "sort", "quicksort", "vals", "spliceVoid", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "blackboard", "concatNative", "nBuckets", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "toDynamic", "allEnums", "get_reason", "set_reason", "rules", "__get", "__set", "__hx_deleteField", "unshift", "_keys", "enumParameters", "facts", "shift", "condition", "reason", "slice"};
