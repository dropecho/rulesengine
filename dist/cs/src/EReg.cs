...
namespace haxe.root {
	public sealed class EReg : global::haxe.lang.HxObject {
		...
		public global::haxe.root.Array<string> split(string s) {
			if (this.isGlobal) {
				return new global::haxe.root.Array<string>(((string[]) (this.regex.Split(((string) (s) ))) ));
			}
			...
			if ( ! (( m as global::System.Text.RegularExpressions.Group ).Success) ) {
				return new global::haxe.root.Array<string>(new string[]{s});
			}
			
			return new global::haxe.root.Array<string>(new string[]{s.Substring(((int) (0) ), ((int) (( m as global::System.Text.RegularExpressions.Capture ).Index) )), s.Substring(((int) (( ( m as global::System.Text.RegularExpressions.Capture ).Index + ( m as global::System.Text.RegularExpressions.Capture ).Length )) ))});
		}
			...
			unchecked {
				...
				while (true) {
					if (( offset >= s.Length )) {
						...
						buf_b.Append(((string) (global::haxe.root.Std.@string(global::haxe.lang.StringExt.substr(s, offset, default(global::haxe.lang.Null<int>)))) ));
						break;
					}
					
					object p = this.matchedPos();
					buf_b.Append(((string) (global::haxe.root.Std.@string(global::haxe.lang.StringExt.substr(s, offset, new global::haxe.lang.Null<int>(( ((int) (global::haxe.lang.Runtime.getField_f(p, "pos", 5594516, true)) ) - ((int) (offset) ) ), true)))) ));
					...
					if (( ((int) (global::haxe.lang.Runtime.getField_f(p, "len", 5393365, true)) ) == 0 )) {
						buf_b.Append(((string) (global::haxe.root.Std.@string(global::haxe.lang.StringExt.substr(s, ((int) (global::haxe.lang.Runtime.getField_f(p, "pos", 5594516, true)) ), new global::haxe.lang.Null<int>(1, true)))) ));
